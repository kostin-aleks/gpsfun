...
tinyMCE.init({
	       ...
	       extended_valid_elements : "a[name|href|title|onclick],img[class|src|border=0|alt|title|hspace|vspace|width|height|align|onmouseover|onmouseout|name],hr[class|width|size|noshade],font[face|size|color|style],span[class|align|style],object[width|height|classid|codebase],param[name|value],embed[src|type|width|height|flashvars|wmode],iframe[title|class|type|width|height|src|frameborder|allowFullScreen]",
	       fullscreen_settings : {
