...
urlpatterns = [path('geokret/info/', map_geokret_info, name="map-geokret-info"),
    ...
    path('cache/<cache_code>/', geokrety_api_who_in_cache, name="geokrety-api-in-cache"),
    path('get/geokrety/', geokrety_map_get_geokrety, name="geokret-map-get-geokrety"),
]
